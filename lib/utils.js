...
exports.fieldsReducer = (reducer) => (context) => (fields, model) => model.isInterface()
    ? fields
    : Object.assign({}, fields, exports.clearRecord(reducer(model.build(context))));
...
exports.reduceFields = (models, reducers) => lodash_1.reduce(reducers, (fields, reducer, name) => (Object.assign({}, fields, { [name]: lodash_1.reduce(models, reducer, {}) })), {});
