export declare const create: (contextModel: import("..").ContextModel<unknown, any>) => {
    subscribe: () => any;
    resolve: ({ node }: {
        node: any;
    }) => any;
...
export declare const remove: (contextModel: import("..").ContextModel<unknown, any>) => {
    subscribe: () => any;
    resolve: ({ node }: {
        node: any;
    }) => any;
...
export declare const update: (contextModel: import("..").ContextModel<unknown, any>) => {
    subscribe: () => any;
    resolve: ({ node }: {
        node: any;
    }) => any;
