...
export declare const isModelBuilder: <Context, Type>(val: any) => val is ModelBuilder<Context, Type, Type>;
export declare const isSchemaBuilder: <Context>(val: any) => val is SchemaBuilder<Context, any>;
