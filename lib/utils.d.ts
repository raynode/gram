...
import { AttributeBuilder, ContextFn, ContextModel, ContextModelFn, DataType, ModelBuilder, ModelType, PageData, Wrapped } from './types';
...
export declare const reduceFields: <Context, Reducers, Models, ReducerKeys extends keyof Reducers>(models: Record<string, ModelBuilder<Context, any>>, reducers: Record<ReducerKeys, FieldReducerFn<Context>>) => Record<ReducerKeys, GraphQLFieldConfigMap<any, any, {
    [key: string]: any;
}>>;
